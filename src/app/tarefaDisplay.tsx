interface TarefaDisplayProps {
    ...
    numberIsDone: number;
    setNumberIsDone: Function;
}

export const TarefaDisplay: React.FC<TarefaDisplayProps> = ({tarefas, handleTarefa, deletarTarefa, filtroEscolhido, numberIsDone, setNumberIsDone}) => {
        ...
        tarefas.map((tarefa, index)  => {
            return (
                ...
                <div key={index} className="flex justify-between mb-2 min-h-6">
                    ...
                    <button onClick={() => {
                        deletarTarefa(index);
                        tarefa.isDone ? setNumberIsDone(numberIsDone - 1) : "";
                    }}>
